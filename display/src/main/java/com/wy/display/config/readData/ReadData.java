 ...
 **/
public class ReadData extends Service<DataSource> {
    ...
    public static void main(String[] args) throws Exception {
        File file = new File("D:\\bigdata\\LtpcData\\2020_3_11\\2triggerTest.bin");
        ...
        DataSource dataSource = readData.readDataSource(dis, file.getAbsolutePath());
    ...
    private void processSimpleData(SimpleData simpleData, ArrayList<SimplifyData> sdList){
        ...
        int channelNum = getChannelNum( simpleData,channelId, simpleData.getSourceBoardAddress());
        ...
        for (int i=0;i<piece;i++) {
            ...
            if (simpleData.getTriggerNumber()<=3){
    ...
    private int  getChannelNum(SimpleData simpleData, int channelId, int sourceBoard){
    ...
    public static List<LtpcChannel> getLtpcChannels() {
        return ltpcChannels;
    }
